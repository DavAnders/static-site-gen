...
class TestTextNode(unittest.TestCase):
    ...
    def test_repr(self):
        node = TextNode("Test node", "plain", "http://example.com")
        expected_repr = "TextNode('Test node', 'plain', 'http://example.com')"
        self.assertEqual(repr(node), expected_repr)
    
    def test_eq_with_and_without_url(self):
        node_with_url = TextNode("Some text", "link", "http://example.com")
